...
public class LoginFormComponent {
    ...
    private final static By correctEmailPasswordTxtSel = MobileBy.xpath("//*[contains(@text, 'Success')]");
    ...
    public String getValidEmailStr(){
        return appiumDriver.findElement(correctEmailPasswordTxtSel).getText();
    }
