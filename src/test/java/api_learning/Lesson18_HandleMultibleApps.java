...
public class Lesson18_HandleMultibleApps {
    public static void main(String[] args) {
        ...
        try {
            ...
            MobileElement formsSelectOptionElem1 = appiumDriver.findElement(MobileBy.AndroidUIAutomator("new UiSelector().textContains(\"Network & internet\")"));
            formsSelectOptionElem1.click();
